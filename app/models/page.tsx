...
const VRAM_GROUPS = [
  ...
  },
  {
    ...
    note: "IC-LoRAs (In-Context LoRAs) attach to the dev model for structural control (pose/depth/edges), motion trajectories, 16-bit HDR generation, and lip-dub. Use the official IC-LoRA ComfyUI workflow with LTXICLoRALoaderModelOnly + LTXAddVideoICLoRAGuide at Reference Downscale Factor 0.5. Place in models/loras/. — See Guide step 7 for the full how-to.",
  },
  {
    id: "text-encoders",
    ...
    note: "Every LTX 2.3 ComfyUI workflow needs a Gemma 3 12B text encoder. Use FP4 mixed (9.5 GB) on 16/24 GB cards; the full BF16 file is for 32 GB+. Workflows reference the BF16 file as 'comfy_gemma_3_12B_it.safetensors' — rename after download. Place in models/text_encoders/. — See Guide step 5.",
  },
  {
    id: "previous",
